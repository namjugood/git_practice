...
def publish_report(scenario: Scenario, ws: Workspace, result: CheckResult, diagnosis: list[str]) -> Optional[str]:
    """검사에 성공했을 때만, 리포트를 README.md로 만들어 이 워크스페이스의 연습 브랜치에 push한다.
